...
from .serializers import InvoiceSerializer, ServiceSerializer, InvoiceSentDashboardSerializer, InvoiceDetailsSerializer, InvoiceNewInvoicesSerializer, InvoiceAllInvoiceSerializer
...
class InvoiceAllInvoiceViewSet(views.APIView):
    permission_classes = [permissions.AllowAny]
